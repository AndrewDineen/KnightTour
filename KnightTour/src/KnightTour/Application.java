package KnightTour;
/**
 * This interface defines some essential functionality for the Knight class
 * Generally, the application interface helps the Knight class determine if a move is valid
 */
import java.util.*;
